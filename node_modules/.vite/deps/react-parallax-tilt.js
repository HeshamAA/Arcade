...
var o = class extends import_react.PureComponent {
  ...
  render() {
    ...
    return (0, import_jsx_runtime.jsx)("div", { ref: (t2) => this.wrapperEl.node = t2, onMouseEnter: this.onEnter, onMouseMove: this.onMove, onMouseLeave: this.onLeave, onTouchStart: this.onEnter, onTouchMove: this.onMove, onTouchEnd: this.onLeave, className: i2, style: n2, children: e2 });
  }
};
o.defaultProps = a;
export {
